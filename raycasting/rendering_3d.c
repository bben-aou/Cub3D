...
/*   Updated: 2022/11/14 08:48:53 by iomayr           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void rendering_3d(t_var *var)
{
    ...
    var->mlx->full_img->addr = mlx_get_data_addr(var->mlx->full_img->img, &var->mlx->full_img->bpp,
        &var->mlx->full_img->line_len, &var->mlx->full_img->endian);
    draw_ceil_floor(var);
