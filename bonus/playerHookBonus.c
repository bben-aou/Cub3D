...
/*   Updated: 2022/11/14 15:49:13 by iomayr           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int checkIfWallB(t_varb *var, int status)
{
    ...
    if (status == 1)
    {
        posX = floor((var->player->x + cos(var->player->rotationAngle) * var->player->moveSpeed) / T_S);
        posY = floor((var->player->y + sin(var->player->rotationAngle) * var->player->moveSpeed) / T_S);
    }
    ...
    {
        posX = floor((var->player->x - sin(var->player->rotationAngle) * var->player->moveSpeed) / T_S);
        posY = floor((var->player->y + cos(var->player->rotationAngle) * var->player->moveSpeed) / T_S);
    }
    else if (status == 4)
    {
        posX = floor((var->player->x + sin(var->player->rotationAngle) * var->player->moveSpeed) / T_S);
